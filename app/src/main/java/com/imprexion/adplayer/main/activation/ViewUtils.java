...
public class ViewUtils {
	...
	public static float getSpValue(float value) {
		if (DEVICE_DENSITY == 0) {
			DEVICE_DENSITY = ContextUtils.get().getResources().getDisplayMetrics().densityDpi;
		}
	...
	public static float getSpValueForFont(float value) {
		float scale = ContextUtils.get().getResources().getDisplayMetrics().scaledDensity;
	...
	public static int getStatusBarHeight() {
		...
		try {
			...
			statusBarHeight = ContextUtils.get().getResources().getDimensionPixelSize(value);
	...
	public static int getScreenWidth() {
		return ContextUtils.get().getResources().getDisplayMetrics().widthPixels;
	}
	...
	public static int getScreenHeight() {
		return ContextUtils.get().getResources().getDisplayMetrics().heightPixels;
	}
