package com.imprexion.adplayer.status;
...
import com.imprexion.adplayer.component.BaiDuLocation;
import com.imprexion.adplayer.net.NetContract;
import com.imprexion.adplayer.net.NetPresenter;
import com.imprexion.adplayer.tools.IconFontTextView;
...
//        }
    ...
    private void requestWeather() {
        ...
        mBdLocation.setLocationUpdateListener(new BaiDuLocation.LocationUpdateListener() {
            ...
            public void updateLoaction(String city, String address) {
                YxLogger.d(TAG, "address =" + address);
    ...
    public void updateWeather(WeatherInfo weatherInfo) {
        ...
        YxLogger.d(TAG, "heWeather6=" + new Gson().toJson(heWeather6));
